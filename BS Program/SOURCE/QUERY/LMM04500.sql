...
EXEC RSP_PM_GET_PRICING_LIST 'rcd', 'ASHMD', '1ROOM', '02', 0, '01', '', '', 'ghc'

--get pricing date list
EXEC RSP_PM_GET_PRICING_DATE_LIST 'RCD','ASHMD','1ROOM','02','02','ghc'

--get next pricing list
EXEC RSP_PM_GET_PRICING_LIST 'rcd', 'ASHMD', '1ROOM', '02', 0, '02', '20240122', '20240122001', 'ghc'
...
VALUES 
	(1, '', '02', 'R001', '01', 500000, 450000, 0)
,	(2, '', '05', 'SC01','01', 2000000, 2000000, 0)
EXEC RSP_PM_MAINTAIN_PRICING 'RCD', 'ASHMD', '02', '1ROOM', '20240628', 'ADD', 'GHC'
EXEC RSP_PM_GET_PRICING_LIST 'rcd', 'ASHMD', '1ROOM', '02', 0, '02', '20240123', '20240123001', 'ghc'
ROLLBACK
...
EXEC RSP_PM_GET_PRICING_LIST 'rcd', 'ASHMD', '1ROOM', '02', 0, '03', '20240122', '20240122001', 'ghc'

--get pricing rate date list
EXEC RSP_PM_GET_PRICNG_RATE_DATE_LIST 'rcd','ASHMD','02','ghc'

--get pricing rate list 
EXEC RSP_PM_GET_PRICING_RATE_LIST 'rcd','ASHMD','02','02','20240627','ghc'
...
('BND',10000,10000),
('TWD',3324.09,3324.09)
EXEC RSP_PM_MAINTAIN_PRICING_RATE 'rcd','ASHMD','02','20240627','ADD','ghc'

EXEC RSP_PM_GET_PRICING_RATE_LIST 'RCD', 'ASHMD','02', '02', '20240122', 'GHC'
