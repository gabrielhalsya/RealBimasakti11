...
namespace GSM04500Service
{
    ...
    public class GSM04510GOADeptController : ControllerBase, IGSM04510GOADept
    {
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<GOADeptDTO> poParameter)
        {
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<GOADeptDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<GOADeptDTO> poParameter)
        {
            string lcMethodName = nameof(R_ServiceGetRecord);
            _loggerGSM04500.LogInfo(string.Format("START process method {0} on Controller", lcMethodName));

            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<GOADeptDTO>();
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<GOADeptDTO> R_ServiceSave(R_ServiceSaveParameterDTO<GOADeptDTO> poParameter)
        {
            string lcMethodName = nameof(R_ServiceSave);
            _loggerGSM04500.LogInfo(string.Format("START process method {0} on Controller", lcMethodName));

            var loEx = new R_Exception();
            var loRtn = new R_ServiceSaveResultDTO<GOADeptDTO>();
            GSM04510GOADeptCls loCls;

            try
            {
                loCls = new GSM04510GOADeptCls();
                loRtn = new R_ServiceSaveResultDTO<GOADeptDTO>();
        ...
        {
            string lcMethodName = nameof(GetJournalGrpGOADeptList);
            _loggerGSM04500.LogInfo(string.Format("START process method {0} on Controller", lcMethodName));

            var loEx = new R_Exception();
            GSM04510GOADeptDBParameter loDbParameter;
            R_Exception loException = new R_Exception();
            IAsyncEnumerable<GOADeptDTO> loRtn = null;
            List<GOADeptDTO> loRtnTemp;
        ...
        private async IAsyncEnumerable<GOADeptDTO> GET_JOURNAL_GRP_GOA_DEPT_LIST(List<GOADeptDTO> poParameter)
        {
