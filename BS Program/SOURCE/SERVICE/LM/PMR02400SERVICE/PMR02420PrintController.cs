    ...
    public class PMR02420PrintController : R_ReportControllerBase
    {
        ...
        private PMR02410PrintDisplayDTO GenerateDataPrint(PMR02400ParamDTO poParam)
        {
            ...
            try
            {
                ...
                var loMappingData = R_Utility.R_ConvertCollectionToCollection<PMR02401SPResultDTO, PMR02410DataDTO>(loCollData);
                loData.Data = new List<PMR02410DataDTO>(loMappingData);
