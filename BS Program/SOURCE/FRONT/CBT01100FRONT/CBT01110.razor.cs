    ...
    public partial class CBT01110 : R_Page
    {
        ...
        private void JournalDet_RDisplay(R_DisplayEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                var data = R_FrontUtility.ConvertObjectToObject<CBT01101DTO>(eventArgs.Data);
        ...
        private void JournalDet_Validation(R_ValidationEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (eventArgs.ConductorMode == R_eConductorMode.Add && (string.IsNullOrWhiteSpace(loData.CCENTER_CODE) && (loData.CBSIS == "B" && _TransactionEntryViewModel.VAR_GSM_COMPANY.LENABLE_CENTER_BS) || (loData.CBSIS == "I" && _TransactionEntryViewModel.VAR_GSM_COMPANY.LENABLE_CENTER_IS)))
                {
                    loEx.Add(R_FrontUtility.R_GetError(
                        typeof(Resources_Dummy_Class),
                        "V24"));
