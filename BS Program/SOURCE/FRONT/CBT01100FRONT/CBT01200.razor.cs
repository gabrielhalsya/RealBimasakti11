...
namespace CBT01100FRONT
{
    public partial class CBT01200 : R_Page
    {
        ...
        private async Task JournalDet_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (CBT01111DTO)eventArgs.Data;
                await _JournalEntryViewModel.GetJournaldetailAsync(loData);
        ...
        {
            if (eventArgs.ColumnName == nameof(CBT01111DTO.CGLACCOUNT_NO))
            {
            ...
            else if (eventArgs.ColumnName == nameof(CBT01111DTO.CCASH_FLOW_CODE))
            {
        ...
        {
            CBT01111DTO loGetData = (CBT01111DTO)eventArgs.ColumnData;
            if (eventArgs.ColumnName == nameof(CBT01111DTO.CGLACCOUNT_NO))
            {
        ...
        private async Task JournalDet_ServiceSave(R_ServiceSaveEventArgs eventArgs)
        {
            ...
            {
                var loData = (CBT01111DTO)eventArgs.Data;
                await _JournalEntryViewModel.SaveJournalDetail(loData);
